...
let userLoginData={}; //Variable to hold new data as input by new user for registration// 
...
let id="", firstname="", lastname="", email="", address="", password=""; 
userLoginData=[{id, firstname, lastname, email, address, password}]; 
//Connecting to submit button//
const register = document.getElementById("loginButton")
register.addEventListener("click",()=>{userLogin();})

//Variables to hold links to member profile data fields./////NO NEED GLOBAL
// let mId="", mFirstName="", mLastName="", mEmail="", mAddress="", mPassword="";
// upProfile= [{mId, mFirstName, mLastName, mEmail, mAddress, mPassword}]; 
...
const changePassword = ()=>{ 
    ...
    window.alert("Your Password Change Successful. Thanks!");
} 
//----->MEMBER CHANGE PASSWORD FUNCTION END----->// 

//----->MEMBER PROFILE SUPABASE UPDATE FUNCTION START----->// 
const updateSupabase = async ()=>{
    await supabaseClient.from(`chusers01`).update(upProfile[0])
    .eq(id, upProfile[0].id)
    .then( (table)=>{
        userLoginData[0] = table.data     //Converted to refined data and stored in Variable//

        //CHECKING HERE AS ITS NOT WORKING

        console.log(upProfile[0].mFirstName,"THE SECOND LINE"); 
        console.log(userLoginData[0].firstname, "THE THIRD LINE"); 
...
const saveProfile = ()=>{
    ...
    const mFirstName = document.getElementById("mFirstName").value; 
    const mLastName = document.getElementById("mLastName").value; 
    const mEmail = document.getElementById("mEmail").value; 
    const mAddress = document.getElementById("mAddress").value; 
    const mPassword = document.getElementById("mPassword").value; 
    let upProfile= [{mId, mFirstName, mLastName, mEmail, mAddress, mPassword}]; //Refreshing the variables with updated user profile. 
    console.log("TEST IF REACHED HERE-1");
    //updated data validation checks. 
    if(!mFirstName) {window.alert(`Please enter your First name`); return;} 
    else if(!mLastName) {window.alert(`Please enter your Last name`); return;} 
    else if(!mEmail) {window.alert(`Please enter your Email`); return;} 
    else if(!mEmail.includes(`@`)) {window.alert(`Please check your email`); return;} 
    else if(mEmail.length<7) {window.alert(`Please check your email`);  return;} 
    else if(!mAddress) {window.alert(`Please enter your Complete Address`); return;} 
    else if(!mPassword) {window.alert(`Password Incorrect`); return;} 
    else if(mPassword != userLoginData[0].password) {window.alert(`Password Incorrect`); return;} 
    // looking for member email in database and update. 
    else if(true){
        console.log("TEST IF REACHED HERE-2");

        for(i=0; i<usersList.length; i++){ 
            console.log(`\nchecking ${usersList[i][`id`]} vs ${upProfile.mId}`)
            if(usersList[i]['id'] == upProfile[0].mId){ 
                //keeping a copy of authenticated updated user complete profile. 
                usersList[i].firstname = upProfile[0].mFirstName; 
                usersList[i].lastname = upProfile[0].mLastName; 
                usersList[i].email = upProfile[0].mEmail; 
                usersList[i].address = upProfile[0].mAddress; 
                //keeping a copy of authenticated user ID for profile update function.
                userLoginData[0].firstname = upProfile[0].mFirstName; 
                userLoginData[0].lastname = upProfile[0].mLastName; 
                userLoginData[0].email = upProfile[0].mEmail; 
                userLoginData[0].address = upProfile[0].mAddress; 
                supabaseMemberIndex = i; //keeping updated copy of member's record index in database. 
                
//CHECKING HERE
                updateSupabase(); //Updating values to supabase. 
            } 
...
const userDashboardActivator = ()=>{ 
    //Linking to member data fields on form. 
    mId= document.getElementById("mId"); 
    mFirstName = document.getElementById("mFirstName"); 
    mLastName = document.getElementById("mLastName"); 
    ...
    mId.value = userLoginData[0].id;
    mFirstName.value = userLoginData[0].firstname;
    mLastName.value = userLoginData[0].lastname;
    mEmail.value = userLoginData[0].email;
    mAddress.value = userLoginData[0].address;
    mPassword.value = userLoginData[0].password;
    ...
    document.getElementById("userProfile").hidden=false; //setting member profile management-fields visible.  
    saveChangesBtn.hidden=true; 

    //Adding event listeners - connecting functions to member profile page buttons. 
...
const userAuthenticator = async (uld)=>{
    let result=[]; 
    // console.log(`Validation started.....`)
    if(!uld.email) {window.alert(`Please enter your Email`); userLoginData=[]; return;} 
    else if(!uld.email.includes(`@`)) {window.alert(`Please check your email`);  userLoginData=[]; return;} 
    else if(uld.email.length<7) {window.alert(`Please check your email`);  userLoginData=[]; return;} 
    else if(!uld.password) {window.alert(`Please enter your Password`);  userLoginData=[]; return;} 
        ...
        for(i=0; i<usersList.length; i++){ 
            ...
            if(usersList[i][`email`] == uld.email){ 
                ...
                if(usersList[i]["password"] == uld.password){ 
                    ...
                    userLoginData = result; //keeping a copy of authenticated user complete profile.
                    supabaseMemberIndex=i;  //keeping a copy of  member's index number in supabase. 
                    // console.log("user Authenticated successfuly")
                    userDashboardActivator();   //Calling function to activate member dashboard area. 
                    return;
                }
            } 
        } 
...
const userLogin = async ()=>{
    ...
    //Storing user input login data to a Variable//
    userLoginData = { email, password}

    // Validating New User Data....if returns true means user authenticated successfully.//
    userAuthenticator(userLoginData); 
...
},{"@supabase/supabase-js":40}],2:[function(require,module,exports){
"use strict";
...
},{"./lib/constants":5,"./lib/cookies":6,"./lib/fetch":7,"./lib/helpers":8}],3:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./GoTrueApi":2,"./lib/constants":5,"./lib/helpers":8,"./lib/polyfills":9}],4:[function(require,module,exports){
"use strict";
...
},{"./GoTrueApi":2,"./GoTrueClient":3,"./lib/types":10}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./version":11}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"cross-fetch":46}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./lib/PostgrestQueryBuilder":15,"./lib/PostgrestRpcBuilder":16,"./lib/constants":18}],13:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./PostgrestClient":12,"./lib/PostgrestFilterBuilder":14,"./lib/PostgrestQueryBuilder":15,"./lib/types":19}],14:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./PostgrestTransformBuilder":17}],15:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./PostgrestFilterBuilder":14,"./types":19}],16:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./PostgrestFilterBuilder":14,"./types":19}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const types_1 = require("./types");
/**
...
},{"cross-fetch":46}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.version = void 0;
// generated by genversion
...
},{"./RealtimeSubscription":22,"./lib/constants":24,"./lib/serializer":26,"./lib/timer":27,"websocket":48}],22:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./lib/constants":24,"./lib/push":25,"./lib/timer":27}],23:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./RealtimeClient":21,"./RealtimeSubscription":22,"./lib/transformers":28}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./version":29}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const constants_1 = require("../lib/constants");
class Push {
...
},{"../lib/constants":24}],26:[function(require,module,exports){
"use strict";
...
},{"./lib":36}],31:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./SupabaseStorageClient":30,"./lib/types":37}],32:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./constants":34,"./fetch":35}],33:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./fetch":35,"cross-fetch":46}],34:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.DEFAULT_HEADERS = void 0;
const version_1 = require("./version");
...
},{"./version":38}],35:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"cross-fetch":46}],36:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./StorageBucketApi":32,"./StorageFileApi":33,"./constants":34,"./types":37}],37:[function(require,module,exports){
...
},{"./lib/SupabaseAuthClient":41,"./lib/SupabaseQueryBuilder":42,"./lib/constants":44,"@supabase/postgrest-js":13,"@supabase/realtime-js":23,"@supabase/storage-js":31}],40:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./SupabaseClient":39,"@supabase/gotrue-js":4,"@supabase/realtime-js":23}],41:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@supabase/gotrue-js":4}],42:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./SupabaseRealtimeClient":43,"@supabase/postgrest-js":13}],43:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@supabase/realtime-js":23}],44:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.DEFAULT_HEADERS = void 0;
// constants.ts
...
module.exports={
  ...
  "_where": "/home/mahboob/code/p/CommunityHub/node_modules/@supabase/realtime-js",
  "author": {
    "name": "Brian McKelvey",
